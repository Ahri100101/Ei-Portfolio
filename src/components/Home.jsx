    ...
    return (
        <div className="p-5 pt-14 w-full h-screen" id="home">
            ...
            <div className="flex flex-col text-center">
                ...
                <p className="text-6xl font-font2 text-transparent bg-clip-text bg-gradient-to-b from-light to-mid py-2">Ariz Ann C. Salazar</p>
            ...
            <div className="text-center font-font1 text-white font-bold py-5">
                <button className="text-lg bg-gradient-to-b from-light to-mid rounded-full px-5 py-1">View Curriculum Vitae</button>
            </div>
        </div>
    )
}
